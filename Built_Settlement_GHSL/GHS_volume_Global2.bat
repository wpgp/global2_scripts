...
:: This script matches GHS built surface total and non-residential rasters (2010, 2015, 2020, 2025 and 2030) to our mastergrid via resampling and clipping to coastlines
...
:: MODIFY AND INSERT BELOW 'X:\LOCATION OF 'GHS_surface_Global2.bat'' (with downloaded input rasters in same folder)
SET mypath=X:\
...
FOR %%i IN (GHS_BUILT_S_*_GLOBE_R2023A_54009_100_V1_0.tif) DO (
...
FOR %%i IN (GHS_BUILT_S_*_GLOBE_R2023A_54009_100_V1_0_4326.tif) DO (
...
FOR %%i IN (GHS_BUILT_S_*_GLOBE_R2023A_54009_100_V1_0_4326_resample.tif) DO (
...
SET "2010_total=%mypath%GHS_BUILT_S_E2010_GLOBE_R2023A_54009_100_V1_0_4326_resample_0_NoData.tif"
SET "2010_NRES=%mypath%GHS_BUILT_S_NRES_E2010_GLOBE_R2023A_54009_100_V1_0_4326_resample_0_NoData.tif"
SET "2015_total=%mypath%GHS_BUILT_S_E2015_GLOBE_R2023A_54009_100_V1_0_4326_resample_0_NoData.tif"
SET "2015_NRES=%mypath%GHS_BUILT_S_NRES_E2015_GLOBE_R2023A_54009_100_V1_0_4326_resample_0_NoData.tif"
SET "2020_total=%mypath%GHS_BUILT_S_E2020_GLOBE_R2023A_54009_100_V1_0_4326_resample_0_NoData.tif"
SET "2020_NRES=%mypath%GHS_BUILT_S_NRES_E2020_GLOBE_R2023A_54009_100_V1_0_4326_resample_0_NoData.tif"
SET "2025_total=%mypath%GHS_BUILT_S_E2025_GLOBE_R2023A_54009_100_V1_0_4326_resample_0_NoData.tif"
SET "2025_NRES=%mypath%GHS_BUILT_S_NRES_E2025_GLOBE_R2023A_54009_100_V1_0_4326_resample_0_NoData.tif"
SET "2030_total=%mypath%GHS_BUILT_S_E2030_GLOBE_R2023A_54009_100_V1_0_4326_resample_0_NoData.tif"
SET "2030_NRES=%mypath%GHS_BUILT_S_NRES_E2030_GLOBE_R2023A_54009_100_V1_0_4326_resample_0_NoData.tif"

call gdal_calc -A !2010_total! -B !2010_NRES! --outfile=GHS_BUILT_S_RES_E2010_GLOBE_R2023A_54009_100_V1_0_4326_resample_0_NoData.tif --calc="A-B" --co BIGTIFF=YES --co COMPRESS=LZW
call gdal_calc -C !2015_total! -D !2015_NRES! --outfile=GHS_BUILT_S_RES_E2015_GLOBE_R2023A_54009_100_V1_0_4326_resample_0_NoData.tif --calc="C-D" --co BIGTIFF=YES --co COMPRESS=LZW
call gdal_calc -E !2020_total! -F !2020_NRES! --outfile=GHS_BUILT_S_RES_E2020_GLOBE_R2023A_54009_100_V1_0_4326_resample_0_NoData.tif --calc="E-F" --co BIGTIFF=YES --co COMPRESS=LZW
call gdal_calc -G !2025_total! -H !2025_NRES! --outfile=GHS_BUILT_S_RES_E2025_GLOBE_R2023A_54009_100_V1_0_4326_resample_0_NoData.tif --calc="G-H" --co BIGTIFF=YES --co COMPRESS=LZW
call gdal_calc -I !2030_total! -J !2030_NRES! --outfile=GHS_BUILT_S_RES_E2030_GLOBE_R2023A_54009_100_V1_0_4326_resample_0_NoData.tif --calc="I-J" --co BIGTIFF=YES --co COMPRESS=LZW

::-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
:: create binary version of total, residential and non-residental covariates

FOR %%i IN (GHS_BUILT_S_*_GLOBE_R2023A_54009_100_V1_0_4326_resample_0_NoData.tif) DO (
...
FOR %%i IN (GHS_BUILT_S_*_GLOBE_R2023A_54009_100_V1_0_4326_resample_0_NoData_1_0.tif) DO (
